...
## Preámbulo 
Alberto Balderas trabaja en el corporativo de una aseguradora como especialista en gestión comercial. Su actividad principal es recabar la información del área de ventas para poder elaborar una radiografía mensual del estatus de ésta. El reporte que él elabora lo presenta a su jefa directa Lorena, quien hace observaciones del contenido y del diseño ya que la información debe ser visualmente legible para todos los gerentes de las 151 tiendas ubicadas en la república mexicana. 
La principal solicitud de Lorena a Alberto es modificar el estilo visual del dashboard con la intención de mejorar el entregable y que la data sea muestre de forma dinámica, sin embargo, Alberto externa que no tiene los conocimientos de diseño necesarios para realizar un rediseño. 

## Objetivo del proyecto
Rediseñar el dashboard considerando las  necesidades del usuario; el flujo y la lógica de la información y el estilo gráfico.

## Entendimiento

### ¿Qué es un dashboard?
Un dashboard es un instrumento de visualización de datos en el que las empresas destacan la información más importante, es decir, una representación gráfica de las principales KPIs. Un dashboard efectivo muestra información procesable y útil de un vistazo. Simplifica la representación visual de datos complejos y ayuda a los interesados a comprender, analizar y presentar ideas clave.
...
- La información presentada ayuda a optimizar estrategias de venta. 
- Incluye diferentes elementos visuales para cada necesidad de los usuarios. 
...
# Diseño 
El producto se diseño para visualización de escritorio.
...
También se le mostró a Alberto Balderas quien indicó los siguientes cambios:
